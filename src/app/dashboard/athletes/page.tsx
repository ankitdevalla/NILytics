...
export default function AthletesPage() {
  ...
  const uniqueSports = React.useMemo(() => {
    const sportSet = new Set(athletes.map(athlete => athlete.sport?.name || 'Unknown'))
  ...
  const filteredAthletes = React.useMemo(() => {
    return athletes
      .filter(athlete => {
        ...
        const matchesSport = 
          sportFilter === 'all' || 
          athlete.sport?.name === sportFilter
  ...
  }, [athletes, searchTerm, genderFilter, sportFilter, sortField, sortDirection])
